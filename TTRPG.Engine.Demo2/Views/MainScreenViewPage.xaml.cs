...
namespace EmptyKeys.UserInterface.Generated {
    ...
    public partial class MainScreenViewPage : UIRoot {
        ...
        private static System.Collections.ObjectModel.ObservableCollection<object> Get_TabControl_Items() {
            ...
            e_5.Header = "Goods";
            // e_6 element
            DataGrid e_6 = new DataGrid();
            e_5.Content = e_6;
            e_6.Name = "e_6";
            e_6.VerticalAlignment = VerticalAlignment.Stretch;
            EventTriggerBehavior e_6_BEH_0 = new EventTriggerBehavior();
            Interaction.GetBehaviors(e_6).Add(e_6_BEH_0);
            InvokeCommandAction e_6_BEH_0_ACT_0 = new InvokeCommandAction();
            e_6_BEH_0.Actions.Add(e_6_BEH_0_ACT_0);
            Binding binding_e_6_BEH_0_ACT_0_Command = new Binding("GoodFocusCommand");
            binding_e_6_BEH_0_ACT_0_Command.Source = e_6_BEH_0;
            e_6_BEH_0_ACT_0.SetBinding(InvokeCommandAction.CommandProperty, binding_e_6_BEH_0_ACT_0_Command);
            e_6_BEH_0.EventName = "GotFocus";
            e_6.AutoGenerateColumns = false;
            DataGridTextColumn e_6_Col0 = new DataGridTextColumn();
            e_6_Col0.Width = 150F;
            e_6_Col0.Header = "Name";
            Binding e_6_Col0_b = new Binding("Name");
            e_6_Col0.Binding = e_6_Col0_b;
            e_6.Columns.Add(e_6_Col0);
            DataGridTextColumn e_6_Col1 = new DataGridTextColumn();
            e_6_Col1.Width = 75F;
            e_6_Col1.Header = "Amount";
            Style e_6_Col1_e_s = new Style(typeof(DataGridCell));
            Setter e_6_Col1_e_s_S_0 = new Setter(DataGridCell.BackgroundProperty, new SolidColorBrush(new ColorW(128, 128, 128, 255)));
            e_6_Col1_e_s.Setters.Add(e_6_Col1_e_s_S_0);
            Setter e_6_Col1_e_s_S_1 = new Setter(DataGridCell.HorizontalAlignmentProperty, HorizontalAlignment.Center);
            e_6_Col1_e_s.Setters.Add(e_6_Col1_e_s_S_1);
            Setter e_6_Col1_e_s_S_2 = new Setter(DataGridCell.VerticalAlignmentProperty, VerticalAlignment.Center);
            e_6_Col1_e_s.Setters.Add(e_6_Col1_e_s_S_2);
            e_6_Col1.ElementStyle = e_6_Col1_e_s;
            Binding e_6_Col1_b = new Binding("Amount");
            e_6_Col1.Binding = e_6_Col1_b;
            e_6.Columns.Add(e_6_Col1);
            Binding binding_e_6_ItemsSource = new Binding("Goods");
            e_6.SetBinding(DataGrid.ItemsSourceProperty, binding_e_6_ItemsSource);
            Binding binding_e_6_SelectedItem = new Binding("SelectedGood");
            e_6.SetBinding(DataGrid.SelectedItemProperty, binding_e_6_SelectedItem);
            items.Add(e_5);
            // e_7 element
